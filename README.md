...
| rotate         | [Docs](https://sharp.pixelplumbing.com/api-operation#rotate)    | `/rotate_45/buffalo.png`                                         | Angle in degrees. Angles that are not a multiple of `90` are filled with the `background` / `b` colour. Without an angle (`/rotate/`) the image is auto-oriented from its EXIF tag.                                                                 |
...
| sharpen        | [Docs](https://sharp.pixelplumbing.com/api-operation#sharpen)   | `/sharpen_2_1_2/buffalo.png`                                     | `{sigma}_{flat}_{jagged}`. `sigma` is between `0.000001` and `10`, `flat` and `jagged` between `0` and `1000000`. Without arguments (`/sharpen/`) a mild sharpen is applied.                                                                       |
...
| blur           | [Docs](https://sharp.pixelplumbing.com/api-operation#blur)      | `/blur_5/buffalo.png`                                            | Sigma, a number between `0.3` and `1000`. Without an argument (`/blur/`) a mild blur is applied.                                                                                                                                                  |
...
| threshold      | [Docs](https://sharp.pixelplumbing.com/api-operation#threshold) | `/threshold_10/buffalo.png`                                      | Integer between `0` and `255` (defaults to `128`).                                                                                                                                                                                               |
...
| modulate       | [Docs](https://sharp.pixelplumbing.com/api-operation#modulate)  | `/modulate_2_1.2_90_10/buffalo.png`                              | Transforms the image using `{brightness}_{saturation}_{hue}_{lightness}`. `brightness` and `saturation` are numbers `>= 0`, `hue` is an integer in degrees.                                                                                       |
